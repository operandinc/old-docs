...
- [Personal Relationship Manager (PRM)](/guides/prm) focuses on using the [related objects endpoint](/operations/search#related-objects) to build next-generation PRM system, which can automatically find and connect closely related people in your network.
